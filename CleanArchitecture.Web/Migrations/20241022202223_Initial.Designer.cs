...
namespace CleanArchitecture.Web.Migrations
{
    ...
    [Migration("20241022202223_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Core.User.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CleanArchitecture.Core.User.User", b =>
                {
                    b.OwnsOne("CleanArchitecture.Core.Glucometer.Glucometer", "Glucometer", b1 =>
                        {
                            ...
                            b1.OwnsMany("CleanArchitecture.Core.Glucometer.GlucoseTest", "GlucoseTests", b2 =>
                                {
                    ...
                    b.OwnsOne("CleanArchitecture.Core.Medication.MedicationPlan", "MedicationPlan", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("char(36)");
                            ...
                            b1.OwnsMany("CleanArchitecture.Core.Medication.Medication", "Medications", b2 =>
                                {
